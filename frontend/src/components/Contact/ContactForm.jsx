              ...
              <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                <div className="sm:col-span-2">
                  ...
                  <div className="mt-2.5">
                    ...
                    />
                    <ErrorMessage name="name" component="div" className="text-orange-500 text-lg mt-1" />
                  </div>
                </div>

                <div className="sm:col-span-2">
                  <label htmlFor="email" className="block text-lg font-semibold leading-7 text-black">
                    Mail
                  </label>
                  <div className="mt-2.5">
                    <Field
                      ...
                      className="block w-full border-0 px-3.5 py-2 bg-black text-white shadow-sm ring-1 ring-inset ring-primary placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary text-lg leading-7"
                    />
                    <ErrorMessage name="email" component="div" className="text-orange-500 text-lg mt-1" />
                  </div>
                </div>

                <div className="sm:col-span-2">
                  <label htmlFor="message" className="block text-lg font-semibold leading-7 text-black">
                    Message
                  </label>
                  <div className="mt-2.5">
                    <Field
                      ...
                      className="block w-full border-0 px-3.5 py-2 bg-black text-white shadow-sm ring-1 ring-inset ring-primary placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary text-lg leading-7"
                    />
                    <ErrorMessage name="message" component="div" className="text-orange-500 text-lg mt-1" />
                  </div>
                </div>
              </div>
            </Form>
